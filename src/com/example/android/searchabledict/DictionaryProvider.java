...
//				DictionaryOpenHelper.KEY_DEFINITION,
	...
	{
		/**
		 * This won't be called with the current implementation, <br>
		 * but if we include {@link SearchManager#SUGGEST_COLUMN_SHORTCUT_ID} as
		 * a column in our suggestions table, <br>
		 * we could expect to receive refresh queries when a shortcutted
		 * suggestion is displayed in Quick Search Box. <br>
		 * <br>
		 * In which case, this method will query the table for the specific
		 * word, <br>
